	...
	<div style=width:522px;>
		<h2 style="text-align:center;font-size:32px;font-weight:500;margin-bottom:30px;">회원가입</h2>
			...
			<div class="pw"><span style= margin-right:41px;>비밀번호 <i class="es2"></i> </span>
				<input id="pw1"type="password"name="pw" placeholder="6~16자 영문,숫자,특수문자 1개 이상씩 혼용 필수"style=width:417px;height:50px;border-radius:3px;><br/>
				<span class="pwcheck">
				<input id="pw2"type="password" placeholder="비밀번호 확인"style=width:417px;height:50px;margin-left:105px;margin-top:10px;border-radius:3px;></span>
			</div>
