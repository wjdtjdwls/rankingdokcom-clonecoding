		...
		<div class = "all_area"style=margin-bottom:-490px;>
			...
			<div class = "content_wrap">
				<div class= "mypage_top_area">
					...
					<div class="my-container"style=position:relative;width:1100px;margin-top:45px;margin-left:106px;height:958.92px;>
						<div class="sidemenu">
							...
							<div>
							<a style=font-size:15px;font-weight:600;color:#333333;>회원정보관리</a><br/>
							<p>
							<a href="delevertSet.jsp" style=color:#ff6001;font-wight:500;>배송지 관리</a><br/>
							<a href="infochange2.jsp" style=color:#333333;>정보수정</a><br/>
							</p>
							</div>
					</div >
					<div id="voice">
					...
					<h3 style=font-size:24px;>배송지 관리</h3> 
					<span style=float:right;position:absolute;top:11px;left:117px;font-size:12px;color:#666666;>*배송지는 최대 30개까지 등록됩니다.</span> 
					<a href="#"id="plus"style=float:right;position:absolute;top:11px;right:0px;font-size:15px;color:#333333;cursor:pointer;>
						새 배송지 추가
					</a>
					<div id="insert"style=width:820px;>
						<div id="inner">
						<table style="width:820px;text-align:center;border-bottom:1px solid #ddd;font-weight:500;position:relative;top: -9px;">
							<tr>
								<th scope="col"style="width:30px;height:19.5px;padding:16px 10px;">선택</th>
								<th scope="col"style="padding:16px 10px;width:80px;height:19.5px">받으실 분</th>
								<th scope="col"style="padding:16px 10px;width:310px;height:19.5px">배송주소</th>
								<th scope="col"style="padding:16px 10px;width:80px;height:19.5px">배송유형</th>
								<th scope="col"style="padding:16px 10px;width:120px;height:19.5px">연락처</th>
								<th scope="col"style="padding:16px 10px;width:80px;height:19.5px">관리</th>
							</tr>
						</table>
														
							<div style ="width:820px;height:429.5px;padding:16px 10px;text-align:center;border-bottom:1px solid #ddd;">			
								<div id="no-data"style="width:800px;height:110px;padding:160px 0px;">
									<i id="message"style=font-size:15px;font-style:normal;>내역이 없습니다.</i>
								</div>
								<button id="btn"><span style=white-space:nowrap;>기본 배송지로 설정</span></button>
							</div>
						</div>
					</div>
				</div>
