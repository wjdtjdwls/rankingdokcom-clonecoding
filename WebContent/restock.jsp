		...
		<section id = "contents_area" class = "container">
			<div class = "content_wrap">
				<div class= "mypage_top_area">
						...
						<div class="sidemenu">
							...
							<a style=font-size:15px;font-weight:600;color:#333333;cursor:default;>주문관리</a><br/>
								<p>
									...
									<a href="restock.jsp"style=color:#ff6001;font-weight:500;>재입고 알림 상품</a><br/>
								</p>
							</div>
					...
					<h3 style=font-size:24px;>재입고 알림 상품</h3> 
						...
						<div id="inner">
							...
							<div style ="width:820px;height:429.5px;padding:16px 10px;text-align:center;">			
								<div id="no-data"style="width:800px;height:110px;padding:160px 0px;">
									<i id="message"style=font-size:15px;font-style:normal;>재입고 알림 설정된 상품이 없습니다.</i>
								</div>
								<div style=margin-top:20px;>
									<a id="btn_prev"></a>
									<span style="line-height:25px;border-bottom:2px solid #FB5001;color:#FB5001;font-weight:700;cursor:pointer;">1</span>
									<a id="btn_after"></a>
								</div>
							</div>
