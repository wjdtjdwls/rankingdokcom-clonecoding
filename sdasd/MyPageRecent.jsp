				...
				<div class="user_info_box">
					<div class="inner">
						<div class="column user_info">
							...
							<div class="txt">
								<p class="greeting"><strong>파주시구너</strong>님 반갑습니다.</p>
								<ul class="sep_list type3"><li>닭과장</li><li class="groupPointRateText">1% 적립</li></ul>
								<p class="level_tip" id="levelUpText">354,602원 더 구매 시, 닭차장 진급!</p>
							</div>
						...
						<dl class="column order">
							<dt>포인트</dt>
							<dd class="text_primary"><a href=""><strong class="num" id="totalUnusedPointText">624</strong>P</a></dd>
						</dl>
					</div>
				</div>
			</div>
						...
						<nav class="side_menu">
							<ul class="menu_list">
								...
								<li>
									...
									<ul class="depth2">
										<li><a style="color:#ff6001;font-weight:500;" href="MyPageRecent.jsp">최근 본 상품</a></li>
				...
				<div class="frame_right">
					<div class="frame_cnt_inner">
						<div class="menu_title_area">
							<h3 class="title_menu">최근 본 상품</h3>
							<div class="right">
											...
											<ul class="btns_list">
												...
												<li>
													<div class="custom_checkbox">
														<input type="checkbox" id="check_0" class="checkbox_wish btn_ext_wish"/>
														<label for="check_0"></label>
													</div>
												</li>
												<li><button type="button" class="btn_icon_trash btn_ext_remove"></button></li>
