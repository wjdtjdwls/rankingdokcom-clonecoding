				...
				<div class="content_wrap">
					...
					<div class="my-container"
						...
						<div class="sidemenu">
							...
							<p>
							<a href="coupon.jsp"style=color:#ff6001;font-weight:500;>쿠폰</a><br/>
						...
						<div id="voice">
							<i id="voiceimg"></i><span
								style="position: relative; top: 0px; left: -30px;">고객의 소리</span>
						</div>
						<div
							style="position: relative; top: -781px; right: -263px; width: 820px; height: 750px;">
							<h3 style="font-size: 24px;">쿠폰</h3>
							<div
								style="margin-top: 15px; border: 1px solid #EEEEEE; width: 818px; height: 100px; background: #F8F8F8; text-align: center;">
								<div style="margin-top: 37px;">
									<a style="color: #333; font-size: 14px; font-weight: 400;">쿠폰
										코드</a> <input type="text" placeholder="쿠폰코드" style="height: 30px;">
									<input type="button" value="쿠폰등록"
										style="background: #666; color: #fff; height: 40px; border-radius: 5px; cursor: pointer">
								</div>
							</div>
								...
								<div id="inner">
									...
									<div
										...
										<div id="no-data"
											...
											<i id="message" style="font-size: 15px; font-style: normal;">사용
												가능한 쿠폰이 없습니다.</i>
										</div>
									</div>
