...
<div class="header-inner">
		...
		<div class="util">
			<ul>
				...
				<li class="list"><a href="infochange2.jsp">정보수정</a></li>
	...
	<div class="gnb-wrap">
		<div class="inner">
			...
			<nav id="gnb" class="gnb">
				<ul>
					<li><a href="realtimeranking2.jsp"><span>랭킹</span></a></li>
					...
					<li id="express"><a><em class="ico-txt-gnb"><span class="blind">특급배송</span></em></a></li>
				</ul>
			</nav>
		</div>
	</div>
